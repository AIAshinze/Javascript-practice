...
function ProductList({ setShowLanding }) {
                    ...
                    return (
                      <div className="product-card" key={plantIndex}>
                        ...
                        <div className="product-card-body">
                          ...
                          <button
                            id={`add-to-cart-${plant.name.toLowerCase().replace(/\s+/g, '-')}`}
